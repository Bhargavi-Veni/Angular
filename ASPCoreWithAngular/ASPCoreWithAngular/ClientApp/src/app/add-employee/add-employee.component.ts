...
export class AddEmployeeComponent implements OnInit {
  ...
  employeeId: number;
  errorMessage: any;
  cityList: City[] = [{cityId: 10, cityName:'james'},
  {cityId: 20, cityName:'jack'},
  {cityId: 30, cityName:'jhonny'},
  {cityId: 40, cityName:'clark'},
  {cityId: 50, cityName:'wood'},
  {cityId: 60, cityName:'root'}];
